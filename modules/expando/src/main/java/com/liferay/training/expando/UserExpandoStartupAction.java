...
public class UserExpandoStartupAction implements LifecycleAction {
    ...
    public void processLifecycleEvent(LifecycleEvent lifecycleEvent) throws ActionException {
        System.out.println("Expando exercice executing");
        
        long companyId = CompanyThreadLocal.getCompanyId();
        
//        Try to get the expandoBridge for the User class and add a customer attribute
//        By setting the secure option to false, we instruct the expandoBridge to
//        use Expando's unchecked local services instead of the permissin-checked remote services
